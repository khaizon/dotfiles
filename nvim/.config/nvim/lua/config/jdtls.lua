...
local function setup_jdtls()
	...
	local cmd = {
		vim.fn.expand("~/.sdkman/candidates/java/21.0.7-tem/bin/java"),
	...
	local settings = {
		java = {
			project = {
				referencedLibraries = {
					"build/libs/**/*.jar",
					"/Users/p1337747/.gradle/caches/modules-2/files-2.1/**/**/*.jar",
				},
			},
			import = {
				gradle = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-11",
						path = vim.fn.expand("~/.sdkman/candidates/java/11.0.27-ms"),
					},
				},
			},
