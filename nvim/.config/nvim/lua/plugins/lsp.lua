		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("gS", fzf.lsp_document_symbols, "Open Document Symbols")
			...
			local servers = {
				...
				mason = {
					...
					pylsp = {
						cmd = {
							vim.fn.expand("~/.local/share/nvim/mason/packages/python-lsp-server/venv/bin/pylsp"),
							"-v",
							"-v",
							"--log-file",
							vim.fn.expand("~/.pylsp.log"),
						},
						filetypes = { "python" },
